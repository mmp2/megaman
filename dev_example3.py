...
# update null_space function
(mm_Y_ltsa_amg, err) = ltsa.ltsa(Geometry, n_components, eigen_solver = 'amg')
print 'amg'
print mm_Y_ltsa_amg
(mm_Y_ltsa_lobpcg, err) = ltsa.ltsa(Geometry, n_components, eigen_solver = 'lobpcg')
print 'lobpcg'
print mm_Y_ltsa_lobpcg
(mm_Y_ltsa_arpack, err) = ltsa.ltsa(Geometry, n_components, eigen_solver = 'arpack')
print 'arpack'
print mm_Y_ltsa_arpack
(mm_Y_ltsa_dense, err) = ltsa.ltsa(Geometry, n_components, eigen_solver = 'dense')
print 'dense'
print mm_Y_ltsa_dense
# remove sklearn dependencies

# work on test function

# work on bnechmarking
