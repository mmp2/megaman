...
def compute_Lk(laplacian_matrix,n_samples,subset):
    """
    Compute the Lk, which is the kth row of L tensor, nbk, which is the indeces
    of neighbors of kth point, and si_map, which is the subset to Lk_tensor
    index map, in this function.

    Lk is generated by laplacian, with its diagonal is the kth row of laplacian
    and its kth row and column be the minus of kth row of laplacian.
    """
    Lk_tensor = []
    nbk = []
