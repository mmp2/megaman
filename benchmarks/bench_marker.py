...
def time_function(X, method, radius, d = None, random_state = None):
    ...
    if method == 'distance_brute':
        ...
        from megaman.embedding.spectral_embedding import SpectralEmbedding
        t0 = time.time()
        ...
        from megaman.embedding.isomap import Isomap
        t0 = time.time()
        try:
        ...
        from megaman.embedding.ltsa import LTSA
        t0 = time.time()
        ...
        from megaman.embedding.locally_linear import LocallyLinearEmbedding
        t0 = time.time()
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Run benchmarker on megaman package')
